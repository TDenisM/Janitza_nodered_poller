...
class='form-row'> <label style='min-width:160px' for='node-input-emptyMsgOnFail'><i class='fa fa-th'></i> <span 
data-i18n='modbus-contrib.label.emptyMsgOnFail'></span></label> <input type='checkbox' id='node-input-emptyMsgOnFail' 
style='max-width:30px'> </div> <div class='form-row'> <label style='min-width:160px' for='node-input-keepMsgProperties'>
...
style='min-width:160px' for='node-input-showStatusActivities'><i class='fa fa-th'></i> <span 
...
style='min-width:160px' for='node-input-showErrors'><i class='fa fa-th'></i> <span 
data-i18n='modbus-contrib.label.showErrors'></span></label> <input type='checkbox' id='node-input-showErrors' 
style='max-width:30px'> </div> <hr> <div class='form-row'> <label style='min-width:160px' for='node-input-useIOFile'><i 
class='fa fa-file-code-o'></i> <span data-i18n='modbus-contrib.label.useIOFile'></span></label> <input type='checkbox' 
id='node-input-useIOFile' style='max-width:30px'> </div> <div id='modbusiofile-row'> <div class='form-row'> <label 
style='min-width:160px' for='node-input-logIOActivities'><i class='fa fa-th'></i> <span 
data-i18n='modbus-contrib.label.logIOActivities'></span></label> <input type='checkbox' id='node-input-logIOActivities' 
style='max-width:30px'> </div> <div class='form-row'> <label style='min-width:160px' for='node-input-useIOForPayload'><i
 class='fa fa-comment-o'></i> <span data-i18n='modbus-contrib.label.useIOForPayload'></span></label> <input 
type='checkbox' id='node-input-useIOForPayload' style='max-width:30px'> </div> <div class='form-row'> <label 
for='node-input-ioFile'><i class='icon-file'></i> <span data-i18n='modbus-contrib.label.ioFile'></span></label> <input 
type='text' id='node-input-ioFile'> </div> </div> </div> </div> </script> <script type='text/x-red' 
data-help-name='modbus-flex-getter'>
 <p> Modbus TCP flexible input triggered read node with connection input parameters. </p> <p>
...
<p>Function node code example for multiple inputs:</p> <code>
 msg.payload = { value: msg.payload, 'fc': 3, 'unitid': 1, 'address': 0 , 'quantity': 10 } return msg </code> </script> 